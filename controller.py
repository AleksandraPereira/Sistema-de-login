...
def retorna_session():
    CONN = "sqlite:///projetocadastrologin.db"
...
class ControllerLogin():
    ...
    def login(cls, email, senha):
        ...
        if len(logado) == 1:
            ...
            return False
#print(ControllerCadastro.cadastrar('Camila', 'camila@bol.com', 'minhasenha'))
print(ControllerLogin.login('camila@bol.com', 'minhasenha'))
